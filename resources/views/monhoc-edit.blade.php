                ...
                <form id="monhocadd" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="sotinchi" value="{{$monhoc->sotinchi}}" placeholder="Nhập số tín chỉ" />
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="ma_cn[]"  class="form-control" multiple>
                            @foreach($chuyennganh as $cn)
                                <option value="{{$cn->id}}"
                                    @foreach($monhoc->chuyennganh as $a)
                                        {{$cn->id==$a->pivot->ma_cn ? 'selected' : ''}}
                                        @endforeach
                ...
                $.ajax({
                    ...
                    statusCode: {
                        422: function(data) {
                            ...
                            $.each(data.responseJSON.errors.sotinchi,function (index,value) {
                                errors.push(value);
